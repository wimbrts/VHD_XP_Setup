:: Write changes to the protected volume and turn EWF back on.cmd, v.1.0
:: Written by Pauli Pesonen December 16, 2007.
:: Immediately disable EWF and commit all changes to the protected volume(s).
